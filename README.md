...
portfolio is a template for your own personal site. You can have yours running on the cloud, But first, make sure you have a GitHub account. Ready, set, go!
...
1. Navigate to the main page of the repository. It should be `https://github.com/username/portfolio/`, where `username` is your GitHub username
2. Click Settings
